    ...
    return (
        <div className='my-25 w-11/12 mx-auto'>
            ...
            <div className='flex justify-center gap-4 mt-4'>
                ...
                <button onClick={()=> setSelectedBtn('cart')} className={`btn ${selectedBtn === 'cart' && 'bg-linear-to-l from-[#9514fa] to-[#4f39f6] text-white'} rounded-3xl px-10`}>Cart(0)</button>


            </div>
                {selectedBtn === 'products' ? <Products products={products} cartIncrease={cartIncrease} setCartIncrease={setCartIncrease}></Products> : <Cart></Cart>}
        </div>
    );
};
